...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nama_kelas) || empty($tingkat)) {
        ...
        // Cek apakah kelas sudah ada (kecuali data yang sedang diedit)
        $check_sql = "SELECT * FROM kelas WHERE nama_kelas = '$nama_kelas' AND tingkat = '$tingkat' AND id != $id";
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="tingkat" name="tingkat" required>
                                ...
                                <option value="X" <?php echo (isset($_POST['tingkat']) ? ($_POST['tingkat'] == 'X') : ($kelas['tingkat'] == 'X')) ? 'selected' : ''; ?>>Kelas X</option>
                                <option value="XI" <?php echo (isset($_POST['tingkat']) ? ($_POST['tingkat'] == 'XI') : ($kelas['tingkat'] == 'XI')) ? 'selected' : ''; ?>>Kelas XI</option>
                                <option value="XII" <?php echo (isset($_POST['tingkat']) ? ($_POST['tingkat'] == 'XII') : ($kelas['tingkat'] == 'XII')) ? 'selected' : ''; ?>>Kelas XII</option>
                            </select>
                        </div>
                    </div>
                </div>
